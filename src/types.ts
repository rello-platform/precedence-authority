...
// =============================================================================
// Outcomes — 13-arm discriminated-union
// =============================================================================

export type PrecedenceOutcome =
  // Successful preempt — exit active, enroll candidate
  | "preempted_chained_baseline"
  // No active, candidate matches — first-enroll (no exit needed)
  | "no_op_first_enroll"
  // Active campaign already targets signal's goal — no change
  | "no_op_same_goal"
  // Lock-tier blocks (cascade order 1-6)
